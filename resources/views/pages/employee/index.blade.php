    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">You can manage all employees, such as editing, deleting and more.</p>
                                        ...
                                        <tbody>
                                            @forelse ($employees as $employee)
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-primary">{{ ucfirst($employee->position) }}</span></td>
                                                    <td>Rp {{ number_format($employee->salary, 0, ',', '.') }}</td>
                                                    <td>{{ Str::limit($employee->address, 30) }}</td>
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <a href="{{ route('employee.edit', $employee->id) }}" class="btn btn-sm btn-info btn-icon">
                                                                <i class="fas fa-edit"></i> Edit
                                                            </a>

                                                            <form action="{{ route('employee.destroy', $employee->id) }}" method="POST" class="ml-2" onsubmit="return confirm('Are you sure?')">
                                                                @csrf
                                                                @method('DELETE')
