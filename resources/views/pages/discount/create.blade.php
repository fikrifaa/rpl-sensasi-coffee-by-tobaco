                    ...
                    <form action="{{ route('discount.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g., Harbolnas Promo">
                                @error('name')
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control selectric" id="type" name="type">
                                        ...
                                        <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : '' }}>Fixed (Nominal)</option>
                                    </select>
                                    @error('type')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('value') is-invalid @enderror" id="value" name="value" value="{{ old('value') }}" placeholder="e.g., 10 or 50000">
                                    @error('value')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card-footer text-right">
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ route('discount.index') }}'">Cancel</button>
