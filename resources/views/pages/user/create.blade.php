...
@push('style')
    ...
    <style>
        ...
        /* Radio Kelompok / Selectgroup Active State */
        ...
        /* Input Group Icon Highlight Override (Mencegah Ikon Kunci Berwarna Biru saat Fokus) */
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">Fill in the fields below to register a new user or staff system.</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="role" value="admin" class="selectgroup-input" {{ old('role', 'admin') == 'admin' ? 'checked' : '' }}>
