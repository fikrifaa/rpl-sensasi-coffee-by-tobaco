    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">Create a new category for your cafe menu (e.g., Coffee, Pastry, Non-Coffee).</p>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="name" value="{{ old('name') }}" placeholder="e.g., Espresso Based">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                    name="description" rows="3" placeholder="Brief description of this category...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
