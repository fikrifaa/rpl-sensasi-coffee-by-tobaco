    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">Modify details for category: <strong>{{ $category->name }}</strong></p>
                    ...
                    <form action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Leave empty if you don't want to change the image. Format: JPG, JPEG, PNG. Max 2MB.</small>
                                @error('image')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="card-footer text-right">
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ route('category.index') }}'">Cancel</button>
