                                ...
                                <div class="float-right">
                                    <form method="GET" action="{{ route('customer.index') }}">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Search by name or phone" name="name" value="{{ request('name') }}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <a href="{{ route('customer.edit', $customer->id) }}" class="btn btn-sm btn-info btn-icon">
                                                                <i class="fas fa-edit"></i> Edit
                                                            </a>

                                                            <form action="{{ route('customer.destroy', $customer->id) }}" method="POST" class="ml-2" onsubmit="return confirm('Are you sure you want to delete this customer?');">
                                                                @csrf
                                                                @method('DELETE')
