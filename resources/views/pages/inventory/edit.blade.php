    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">Update details for inventory item: <strong>{{ $inventory->name }}</strong></p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"
                                    ...
                                    name="stock" value="{{ old('stock', $inventory->stock) }}">
                                @error('stock')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="unit" value="{{ old('unit', $inventory->unit) }}">
                                @error('unit')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
